                               ...
                               //expressions people put on facebook :P
{
    ...
    String findPostfix(String inputP)//this will return the postfix expression of given input
    {
        String temp="";
...
//    }
    ...
    float evaluatePostfix(String inputP)//this will return the final result after evaluating postfix expression
    {
